...
public class Session : ISession
{
    ...
    public async Task<bool> LoginAsync(string username, string password)
    {
        ...
        var user = await dbContext.Users.FirstOrDefaultAsync(user => user.Username == username).ConfigureAwait(false);
    ...
    {
        await using var dbContext = _dbContextFactory();
        var hasExistingUser = await dbContext.Users.AnyAsync(user => user.Username == username).ConfigureAwait(false);
