...
public class PaperReviewerShareCalculator : ICalculator
{
    private readonly AppDbContext _appDbContext;
    private readonly LogDbContext _logDbContext;

    public PaperReviewerShareCalculator(AppDbContext appDbContext, LogDbContext logDbContext)
    {
    ...
    public async Task CalculateAsync(CancellationToken cancellationToken)
    {
        ...
        foreach (var creationEntryId in creationEntryIds)
        {
            ...
            foreach (var reviewer in reviewers)
            {
                ...
                var shareMessage = new PaperReviewerShareMessage { Paper = creationMessage.Paper };
                var shareEntry = new LogEntry
                {
                    Step = ProtocolStep.PaperReviewerShare,
